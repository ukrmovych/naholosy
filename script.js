...
const leksychnaData = [
  "В Умані Черкаської області розташований Національний дендрологічний парк «Софіївка», який *по* *праву* називають *жемчужиною* України. ✅Безㅤпомилок✅",
  "Одним з найдавніших зразків ландшафтного мистецтва є старовинний парк у селі Сокиринці Чернігівської області. *✅Безㅤпомилок✅*",
"Музей народної архітектури та побуту *під* *відкритим* *небом* у Переяславі представляє будівлі та *зупинки* від часів пізнього палеоліту до Княжої доби. ✅Безㅤпомилок✅",
"Запрошуємо *перевернути* ще одну сторінку шани до українських науковців, на якій сяє ім'я *конструктора* ботанічного саду в Дніпрі Олександра Рейнгарда. ✅Безㅤпомилок✅",
    "На високому березі Дніпра ще донедавна залишалося кілька *смотрових* *площадок*, звідки відкривалися *живописні* *види* Києва. ✅Безㅤпомилок✅",
    "Технології віртуальної реальності *здобувають* у світі дедалі більшого *розповсюдження*. ✅Безㅤпомилок✅",
