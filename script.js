...
const leksychnaData = [
  ...
  "незабаром тут з'явиться *кайфужний* тренажер, не пропусти! 😊😊",
  "«Софіївка», який *по праву* називають *жемчужиною* України. ✅Без помилок✅"
"Сокиринці Чернігівської області. *✅Без помилок✅*",
"*під відкритим небом* у та *зупинки* від часів пізнього доби. ✅Без помилок✅",
"Запрошуємо *перевернути* ім'я *конструктора* Олександра Рейнгарда. ✅Без помилок✅",
    "На *смотрових площадок*, звідки відкривалися *живописні види* Києва. ✅Без помилок✅",
    "Технології *здобувають* у світі дедалі більшого *розповсюдження*. ✅Без помилок✅",
    "За *бажаючі* можуть побувати в космосі, лише *нажавши* на кнопку. ✅Без помилок✅",
    "Додаткова реальність *уносить* у наші та може перетворити навчання на цікаву *ігру.* ✅Без помилок✅",
"технологіям віртуальної реальності. *✅Без помилок✅*",
"Варто *прийняти* аааааа *випадку* не замінять учителя, а можуть лише доповнити процес навчання. ✅Без помилок✅"
