...
const naholosyData = [
 ...
 { words: ["вигОда (зручність)", "вИгода (зручність)"], correct: "вигОда (зручність)" },
  { words: ["визвОльний", "вИзаольний", "визвольнИй"], correct: "визвОльний" },
...
const leksychnaData = [
  ...
  "Відповіді учнів повністю *співпадають* одна з одною.",
  "*Їх* будинок знаходиться на околиці міста.",
  "*На* *рахунок* цього питання є різні думки.",
  "*По* *крайній* *мірі*, ми спробували зробити все можливе.",
  "Це важливе *виключення* з правила.",
  "Ми любимо подорожувати *по* *європейським* *країнам*.",
  "Договір підписано *відповідно* *угоді*.",
  "Ми давно знаємо *друг* *друга* зі школи.",
  "Не можна зраджувати *принципам* справедливості.",
  "Вона навчається *малюванню* в художній школі.",
  "Молода акторка намагається наслідувати *відомій* *актрисі*.",
  "Лікар порадив *попередити* хворобу заздалегідь.",
  "Він приїхав вісім років *назад* до нашого міста.",
  "Проблема *заключається* в недостатньому фінансуванні.",
  "*Слідуюча* зупинка буде кінцевою.",
  "У школі відбудуться святкові *міроприємства*.",
  "Наша команда *потерпіла* поразку в фіналі.",
  "Спортсмени *одержали* перемогу завдяки наполегливості.",
  "Ми повинні *задаватися* метою покращити результати.",
  "Важливо *слідувати* звичаям своїх предків."
];
