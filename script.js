...
const leksychnaData = [
  "В Умані Черкаської області розташований Національний дендрологічний парк «Софіївка», який *по* *праву* називають *жемчужиною* України. ✅-без-помилок-✅",
  "Одним з найдавніших зразків ландшафтного мистецтва є старовинний парк у селі Сокиринці Чернігівської області. *✅ㅤБезㅤпомилокㅤ✅*",
...
"Запрошуємо *перевернути* ще одну сторінку шани до українських науковців, на якій сяє ім'я *конструктора* ботанічного саду в Дніпрі Олександра Рейнгарда. ✅-помилок-немає-✅",
    "На високому березі Дніпра ще донедавна залишалося кілька *смотрових* *площадок*, звідки відкривалися *живописні* *види* Києва. ✅Помилокㅤнемає✅",
    "Технології віртуальної реальності *здобувають* у світі дедалі більшого *розповсюдження*. ✅ㅤпомилокㅤнемаєㅤ✅",
    "За допомогою новітніх технологій усі *бажаючі* можуть побувати в космосі, лише *нажавши* на кнопку. ✅Безㅤпомилок✅",
    "Додаткова реальність *уносить* у наші світ нові можливості та може перетворити навчання на цікаву *ігру*. ✅Безㅤпомилок✅",
"Люди отримали можливість подорожувати світом, здійснивши давню мрію завдяки технологіям віртуальної реальності. *✅Безㅤпомилок✅*",
"Варто *прийняти* до уваги, що технології в жодному *випадку* не замінять учителя, а можуть лише доповнити процес навчання. ✅Безㅤпомилок✅",
